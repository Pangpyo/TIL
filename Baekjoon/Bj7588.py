...
def solution():
    ...
    while True:
        ...
        if n == 0:
            break
        answer.append('')
        answer.append(f'Amicable numbers between 1 and {n}')
        flag = True
        for a, b in amicables:
            if b <= n:
                flag = False
                answer.append(' '.join(map(str, (a, b))))
        if flag:
            answer.append('None')
    return answer
